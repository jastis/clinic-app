...
@section('content')
    ...
    <div data-render="app">
        ...
        <doctor-offcanvas type="{{ __('staff') }}" default-image="{{ default_file_url() }}"
    ...
    <x-backend.advance-filter>
        ...
        @unless (auth()->user()->hasRole('doctor'))
            <div class="form-group datatable-filter">
                ...
                <input type="text" name="doctor_name" id="doctor_name" class="form-control"
                    placeholder="{{ __('service.all') }} {{ __('clinic.doctors') }}">
            ...
            <div class="form-group datatable-filter">
                ...
                <input type="text" name="email" id="email" class="form-control"
                    placeholder="{{ __('service.all') }} {{ __('clinic.lbl_Email') }}">

            </div>
            <div class="form-group datatable-filter">
                <label class="form-label" for="contact">{{ __('clinic.lbl_contact_number') }}</label>
                <input type="text" name="contact" id="contact" class="form-control"
                    placeholder="{{ __('service.all') }} {{ __('clinic.lbl_contact_number') }}">
        ...
        @unless (auth()->user()->hasRole('receptionist'))
            <div class="form-group datatable-filter">
                <label class="form-label" for="column_clinic">{{ __('clinic.lbl_clinic_center') }}</label>
