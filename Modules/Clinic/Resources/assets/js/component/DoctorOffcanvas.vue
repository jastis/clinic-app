      ...
      <div class="offcanvas-body">
        <div class="row">
          ...
          <div class="col-md-6">
            ...
            <InputField type="number" :label="$t('clinic.lbl_postal_code')" :placeholder="$t('clinic.lbl_postal_code')" v-model="pincode" :error-message="errors['pincode']" :error-messages="errorMessages['pincode']"> </InputField>
          </div>
          <div class="col-md-6">
            <div class="form-group">
          ...
          <div class="col-md-4">
            ...
            <InputField :label="$t('clinic.lbl_lat')" :placeholder="$t('clinic.lbl_lat')" v-model="latitude" :error-message="errors['latitude']" :error-messages="errorMessages['latitude']"> </InputField>
          </div>
          <div class="col-md-4">
            <label class="form-label" for="address">{{ $t('clinic.lbl_long') }}</label>
            <InputField :label="$t('clinic.lbl_long')" :placeholder="$t('clinic.lbl_long')" v-model="longitude" :error-message="errors['longitude']" :error-messages="errorMessages['longitude']"></InputField>
          </div>
          ...
          <div class="row">
            ...
            <div class="col-md-6 create-service-image">
              <label for="" class="form-label w-100">{{ $t('clinic.lbl_certificate') }}</label>
              <ImageComponent :ImageViewer="certificate_url" v-model="certificate_image" />
            </div>
          </div>
          ...
          <div class="col-md-12 mb-3">
            ...
            <span class="p-0 border-0 text-secondary d-flex justify-content-end w-100 bg-transparent" @click="clear">Clear</span>
          </div>
          <div class="col-md-12">
            <div class="form-group">
...
const getClinic = (value) => {
  clinic_id.value = []
  service_id.value = []
  useSelect({ url: CLINIC_CENTER_LIST, data: { id: value } }, { value: 'id', label: 'clinic_name' }).then((data) => (clinicCenter.value = data))
}
...
const defaultData = () => {
  ...
  return {
    ...
    password: '',
    profile_image: [],
    certificate_image: [], // Add this line
    status: 1,
    vendor_id: '',
    clinic_id: [],
    service_id: [],
    ...
    signature: '',
    custom_fields_data: {},
    user_type: module_name // Added this line
  }
}

// const USER_TYPE = ref('')
const image_url = ref()
const certificate_url = ref()
//const certificate_image = ref([])
//  Reset Form
const setFormData = (data) => {
  image_url.value = data.profile_image
  certificate_url.value = data.certificate_image // Added this line
  resetForm({
    values: {
      id: data.id,
      ...
      certificate_image: data.certificate_image, // Added this line
      ...
      user_type: data.user_type || module_name // Added this line
    }
  })
}
...
const validationSchema = yup.object({
  ...
  // certificate_image: yup.array().required('Certificate image is required')
...
const { value: user_type } = useField('user_type') // Added this line
const { value: certificate_image } = useField('certificate_image') // Added this line
